...
module.exports = {
  ...
  async execute(interaction, client) {
    ...
    if (!player.paused) {
      return interaction.reply({ content: t('commands.resume.already_playing'), ephemeral: true });
    }

    await player.pause(false);
    return interaction.reply({ content: t('commands.resume.success'), ephemeral: true });
  }
};
